...
This is a three node cluster, running Kubernetes 1.13.7 using D-series VMs with 2 cores to minimize costs but allow for reasonable reliability of the cluster.
