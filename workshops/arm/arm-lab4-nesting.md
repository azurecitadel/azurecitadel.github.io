...
You can achieve a lot with Azure and the ARM templates by using standalone templates.  And you can wrap scripts around those to generate parameters on the fly, and to submit multiple templates into one or more resource groups.  

However, when you get into larger architectural standards, or into specific application patterns, then nested templates can be very useful.
...
1. Introduction to complex deployments and t-shirt sizes, a
1/ Additiona reading - links to the online docs and PDFs from the AzureCAT team
