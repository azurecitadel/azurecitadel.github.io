...
The first peering resource is straightforward and goes into the resource group we are deploying into.  The second peering is a nested inline template deployment into the hub's resource group.  Each peering points to the resource ID of the remote vNet. 
